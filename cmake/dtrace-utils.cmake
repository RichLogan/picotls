...
FUNCTION (DEFINE_DTRACE_DEPENDENCIES d_file prefix)
    ADD_CUSTOM_COMMAND(
        ...
        DEPENDS ${d_file})
    ADD_LIBRARY(generate-${prefix}-probes INTERFACE ${CMAKE_CURRENT_BINARY_DIR}/${prefix}-probes.h)
    ...
    IF (DTRACE_USES_OBJFILE)
        ADD_CUSTOM_COMMAND(
            ...
            DEPENDS ${d_file})
        TARGET_SOURCES(generate-${prefix}-probes INTERFACE ${CMAKE_CURRENT_BINARY_DIR}/${prefix}-probes.o)
